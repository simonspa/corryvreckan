...
namespace gbl {
    ...
    /// access element (i,j)
    inline double& VMatrix::operator()(unsigned int iRow, unsigned int iCol) { return theVec[numCols * iRow + iCol]; }

    /// access element (i,j)
    inline double VMatrix::operator()(unsigned int iRow, unsigned int iCol) const { return theVec[numCols * iRow + iCol]; }

    /// access element (i)
    inline double& VVector::operator()(unsigned int iRow) { return theVec[iRow]; }

    /// access element (i)
    inline double VVector::operator()(unsigned int iRow) const { return theVec[iRow]; }

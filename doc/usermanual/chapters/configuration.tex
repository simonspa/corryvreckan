...
\item The \parameter{material_budget} defines the material budget of the sensor layer in fractions of the radiation length, including support structures.
  structures. If no value is defined a default of zero is assumed. A given value has to be larger than zero.

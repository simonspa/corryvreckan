...
void AnalysisTiming::initialise() {
    ...
    hClusterMap_leftTail = new TH2F("hClusterMap_leftTail",
                                    ...
                                    0,
                                    m_detector->nPixels().Y());
    hTot_leftTail = new TH1F("hTot_lefTail", "hTot_lefTail", 2 * 64, -64, 64);
    ...
    hClusterMap_rightTail = new TH2F("hClusterMap_rightTail",
                                     ...
                                     0,
                                     m_detector->nPixels().Y());
    hTot_rightTail = new TH1F("hTot_lefTail", "hTot_lefTail", 2 * 64, -64, 64);
    ...
    gTimeCorrelationVsRow = new TGraphErrors(m_detector->nPixels().Y());
...
void AnalysisTiming::finalise() {
    ...
    if(m_calcCorrections) {
        ...
        for(int iBin = 0; iBin < nRows; iBin++) {
            ...
            gTimeCorrelationVsRow->SetPoint(iBin, iBin, timePeak);
            gTimeCorrelationVsRow->SetPointError(iBin, 0, timePeakErr);

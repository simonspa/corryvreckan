...
#ifndef CORRYVRECKAN_TIMESTAMP_H
#define CORRYVRECKAN_TIMESTAMP_H 1
...
namespace corryvreckan {
    ...
    public:
        ...
        Timestamp(){};
        Timestamp(double timestamp) : Object(timestamp){};
         ...
         */
        static std::type_index getBaseType() { return typeid(Timestamp); }
    ...
    using TimestampVector = std::vector<std::shared_ptr<Timestamp>>;
} // namespace corryvreckan

#endif // CORRYVRECKAN_TIMESTAMP_H
